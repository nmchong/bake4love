...
export default function CalendarRow({
  ...
  return (
    <div className="flex flex-row items-center w-full px-6 mt-4">
      ...
      <button
        className={clsx(
          "min-w-[100px] h-[86px] min-h-[86px] mb-4 rounded-md p-3 text-sm border flex flex-col items-center justify-center font-bold transition-colors mr-4 cursor-pointer",
          allItemsSelected
